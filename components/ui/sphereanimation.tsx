        ...
        for (let i = 0; i < pathLength; i++) {
          animations.push(
            anime({
              ...
              stroke: {
                value: ["#3b82f6", "rgba(59, 130, 246, 0.15)"],
                duration: 500,
              },
              translateX: [2, -4],
              translateY: [2, -4],
    ...
    <div className={`absolute right-0 top-1/2 -translate-y-1/2 
      ...
      <div
        ...
        className="absolute left-1/2 top-1/2 
          w-[300px] h-[300px] -ml-[150px] -mt-[150px]
          sm:w-[400px] sm:h-[400px] sm:-ml-[200px] sm:-mt-[200px]
          md:w-[500px] md:h-[500px] md:-ml-[250px] md:-mt-[250px]
          lg:w-[580px] lg:h-[580px] lg:-ml-[290px] lg:-mt-[290px]
          transition-all duration-300 ease-in-out"
      >
        <svg
          className="sphere transition-transform duration-300 ease-in-out"
          viewBox="0 0 440 440"
        ...
        >
          <defs>
            ...
            >
              ...
              <stop stopColor="#1d4ed8" offset="50%" />
